...
def test_create_results_dataframe_and_columns():
    results = [
        {"run_name": "run1", "nacl_conc": 0.0, "pka_reg": 5.0, "eq_qc_pass": True, "veq_used": 25.0, "source_file": "a.csv"},
        {"run_name": "run2", "nacl_conc": 0.0, "pka_reg": 5.2, "eq_qc_pass": True, "veq_used": 25.1, "source_file": "b.csv"},
        {"run_name": "run3", "nacl_conc": 0.1, "pka_reg": 4.9, "eq_qc_pass": False, "veq_used": 24.0, "source_file": "c.csv"},
    ]
